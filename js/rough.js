...
const a1 = annotate(n1, { type: 'highlight', color: '#8A2BE2', padding: 10 });

const n2 = document.querySelector('#draw');
const a2 = annotate(n2, { type: 'box', color: '#8A2BE2', padding: 5 });

const n3 = document.querySelector('#draw2');
const a3 = annotate(n3, { type: 'underline', color: '#8A2BE2', padding: 0 });

const n4 = document.querySelector('#draw3');
const a4 = annotate(n4, { type: 'underline', color: '#8A2BE2', padding: 0 });

const n5 = document.querySelector('#cardsRough1');
const a5 = annotate(n5, { type: 'box', color: '#8A2BE2', padding: 0 });

const n6 = document.querySelector('#cardsRough2');
const a6 = annotate(n6, { type: 'box', color: '#8A2BE2', padding: 0 });

const n7 = document.querySelector('#cardsRough3');
const a7 = annotate(n7, { type: 'box', color: '#8A2BE2', padding: 0 });
...
const n18 = document.querySelector('#img-boxe2');
const a18 = annotate(n18, { type: 'box', color: '#fff', padding: 0 });
